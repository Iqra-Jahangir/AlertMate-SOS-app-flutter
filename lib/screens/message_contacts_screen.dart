...
class MessageContactsScreen extends StatelessWidget {
  final List<Contact> emergencyContacts = [
    Contact(id: '1', name: 'Mother', number: '1234567890'),
    Contact(id: '2', name: 'Father', number: '2345678901'),
    Contact(id: '3', name: 'Hanan', number: '0326 7698989'),
    Contact(id: '4', name: 'Emergency Contact', number: AppConstants.emergencyNumber),
  ];
